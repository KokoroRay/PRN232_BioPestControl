    ...
    public partial class AddCropsTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCrops", x => new { x.ProductId, x.CropId });
                    table.ForeignKey(
                        name: "FK_ProductCrops_Crops_CropId",
                        column: x => x.CropId,
                        principalTable: "Crops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCrops_Products_ProductId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Cây lương thực chính yếu, dễ gặp sâu đục thân, rầy nâu, đạo ôn.", "https://images.unsplash.com/photo-1590682680695-43b964a3ae17?q=80&w=600&auto=format&fit=crop", true, "Lúa (Rice)", "lua" },
                    { 2, "Cây xoài, sầu riêng, cam bưởi... Cần nhiều vi lượng để nuôi trái, ra hoa.", "https://images.unsplash.com/photo-1595163155799-1bd12028ab67?q=80&w=600&auto=format&fit=crop", true, "Cây Ăn Trái", "cay-an-trai" },
                    { 3, "Rau ăn lá, họ dưa bầu bí... dễ gặp sâu tơ, bọ trĩ, phấn trắng.", "https://images.unsplash.com/photo-1506484381205-f7945653044d?q=80&w=600&auto=format&fit=crop", true, "Rau Màu", "rau-mau" },
                    { 4, "Cà phê, hồ tiêu, cao su, điều... Các loại cây có giá trị kinh tế cao, cần quản lý nấm bệnh, rệp sáp rễ.", "https://images.unsplash.com/photo-1611162458324-aae1eb4129a4?q=80&w=600&auto=format&fit=crop", true, "Cây Công Nghiệp", "cay-cong-nghiep" },
                    { 5, "Khoai lang, sắn, khoai tây, cà rốt... Cần thuốc trừ tuyến trùng rễ và nhện đỏ.", "https://images.unsplash.com/photo-1593005872758-00ee9c1e7ea0?q=80&w=600&auto=format&fit=crop", true, "Cây Lấy Củ", "cay-lay-cu" },
                    { 6, "Hoa hồng, lan, cúc... Dễ mắc bệnh rỉ sắt, đốm lá và nhện đỏ.", "https://images.unsplash.com/photo-1490750967868-88cb4ecb07fa?q=80&w=600&auto=format&fit=crop", true, "Hoa và Cây Cảnh", "hoa-cay-canh" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_ProductCrops_CropId",
                table: "ProductCrops",
                column: "CropId");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Bo và Kẽm là các yếu tố vi lượng thiết yếu cho cây trồng...", null, false, null, "Vi lượng-BOROZINC", "sp0001", null, 180000m, null },
                    { 2, 1, 26, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Thuốc trừ sâu sinh học, 100% nguồn gốc từ thực vật...", null, false, null, "TT-ANONIN 1EC", "sp0002", null, 220000m, null },
                    { 3, 1, 23, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Công thức mới với khả năng tác động mạnh...", null, false, null, "TT SNAILTA GOLD 750WP", "sp0003", null, 220000m, null },
                    { 4, 1, 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Giúp ra hoa sớm, đồng loạt...", null, true, null, "TANO_606", "sp0004", null, 130000m, null },
                    { 5, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Giúp cây trồng phát triển nhanh, khỏe...", null, false, null, "TANO_601", "sp0005", null, 120000m, null },
                    { 6, 1, 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Sunphat Kẽm là muối Kẽm vô cơ...", null, true, null, "SUNPHAT_KẼM", "sp0006", null, 220000m, null },
                    { 7, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Tăng độ cứng cây, chống chịu sâu bệnh...", null, true, null, "SPC - NPK", "sp0007", null, 200000m, null },
                    { 8, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "TT BIOBECA 0.1SP giúp giữ xanh lá đòng...", null, true, null, "TT BIOBECA 0.1SP", "sp0008", null, 190000m, null },
                    { 9, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Kích thích phát triển bộ rễ...", null, true, null, "SPC_MKP", "sp0009", null, 230000m, null },
                    { 10, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Hạn chế chiều cao cây...", null, true, null, "SPC_KALI_SILIC", "sp0010", null, 250000m, null },
                    { 11, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "SAMINO 5.1 SL là chất kích thích sinh học...", null, true, null, "SAMINO_51SL", "sp0011", null, 210000m, null },
                    { 12, 1, 4, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "SAIGON - P1 giúp tăng cường đẻ nhánh...", null, true, null, "SAIGON_P115WP", "sp0012", null, 260000m, null },
                    { 13, 1, 3, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "SAGOLATEX 2.5 PA là thuốc kích thích...", null, true, null, "SAGOLATEX", "sp0013", null, 190000m, null },
                    { 14, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Giúp thuốc BVTV loang trải đều...", null, true, null, "SAGO SÓNG THẦN", "sp0014", null, 195000m, null },
                    { 15, 1, 17, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "SAGO ĐỒNG được sử dụng để pha chế...", null, false, null, "SAGO ĐỒNG", "sp0015", null, 250000m, null },
                    { 16, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Đang cập nhật", null, true, null, "SAGO SIÊU HẤP", "sp0016", null, 220000m, null },
                    { 17, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Tăng khả năng bám dính...", null, true, null, "SAGO BÁM DÍNH", "sp0017", null, 300000m, null },
                    { 18, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Giúp phát triển bộ rễ khỏe...", null, true, null, "PLASTIMULA 1SL", "sp0018", null, 230000m, null },
                    { 19, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Giúp phá vỡ trạng thái ngủ...", null, true, null, "SAGO AXIT", "sp0019", null, 180000m, null },
                    { 20, 1, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Giúp đất tơi xốp, giàu mùn...", null, true, null, "ORGANIC NOKAYO", "sp0020", null, 170000m, null },
